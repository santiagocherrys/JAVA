...
public class VueloModel implements CRUD {
    ...
    public List<Vuelo> buscarPorDestino(){
        ...
        if(listaVuelos.size()> 0){
            ...
            //String[] choices = new String[listaVuelos.size()];
            ArrayList<String> unic = new ArrayList<>();

            //llenar el array con basura
            //int a= 0;
            //for(String iterador: choices){
            //    choices[a] = "X" + Integer.toString(a);
            //    a++;
            //}

            //Se crea un array para quitarle la X
            ...
            for(Object iterador : listaVuelos){
                Vuelo vuelo = (Vuelo) iterador;
                    ...
                    //System.out.println("Sorted Array = " + Arrays.toString(choices));
